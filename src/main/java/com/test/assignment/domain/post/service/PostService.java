package com.test.assignment.domain.post.service;
...
import com.test.assignment.domain.post.repository.BoardDefRepository;
import com.test.assignment.domain.post.repository.PostRepository;
import com.test.assignment.domain.post.repository.PostTagRepository;
import com.test.assignment.domain.post.repository.TagRepository;
import com.test.assignment.global.response.exeption.CustomAccessDeniedException;
import com.test.assignment.global.response.exeption.CustomEntityNotFoundException;
import com.test.assignment.global.response.exeption.InvalidInputException;
